	...
	class rhsusf_acc_harris_bipod					  		{ quality = 2; price = 50; };
	...
	// class rhs_weap_m24sws_blk   					{ quality = 3; price = 1000; }; // these are bandit only
	// class rhs_weap_m24sws_ghillie   				{ quality = 3; price = 1000; }; // these are bandit only
	// class rhs_weap_m40a5   						{ quality = 3; price = 1000; }; // these are bandit only
	// class rhs_weap_m40a5_d   					{ quality = 3; price = 1000; }; // these are bandit only
	// class rhs_weap_m40a5_w   					{ quality = 3; price = 1000; }; // these are bandit only
