...
class CfgCraftingRecipes
{
	...
	#include "CRAFT\recipes.hpp"

};
class CfgExileCustomCode
{
	//vector  shutdown due to Q/E keys not working anti0hack? 12-15-17 -NoX-
	ExileClient_object_construction_move = "custom\eXpochVectorBldg\ExileClient_object_construction_move.sqf";
	//ExileClient_gui_hud_event_onKeyDown = "custom\eXpochVectorBldg\ExileClient_gui_hud_event_onKeyDown.sqf"; //used in Exile_Server_Overrides folder -edited for vector
	ExileClient_gui_hud_event_onKeyUp = "custom\eXpochVectorBldg\ExileClient_gui_hud_event_onKeyUp.sqf";
	ExileClient_construction_beginExistingObject = "custom\eXpochVectorBldg\ExileClient_construction_beginExistingObject.sqf";
	ExileClient_construction_beginNewObject = "custom\eXpochVectorBldg\ExileClient_construction_beginNewObject.sqf";
	ExileClient_construction_thread = "custom\eXpochVectorBldg\ExileClient_construction_thread.sqf";
	ExileClient_gui_constructionMode_update = "custom\eXpochVectorBldg\ExileClient_gui_constructionMode_update.sqf";
	ExileClient_util_world_canBuildHere = "custom\eXpochVectorBldg\ExileClient_util_world_canBuildHere.sqf";
	//HAPPY's REVIVE
	...
	//RZ INFECTION
	ExileClient_object_item_consume = "custom\RZ\ExileClient_object_item_consume.sqf";
...
//	#include "Custom\rad_zone\CfgExileCustomCode.hpp"
	#include "CfgExileCustomCode.cpp" //For extdb3
};
class CfgExileEnvironment
{
	class Chernarus
	{
		...
		class Radiation
		{
            ...
            enable = 1;
            contaminatedZones[] = {
				{{12349.2,12619.5,0}, 900, 40},	//NE Airfield 	(coords-radius1-radius2)
				//{{4483.54,8235.07,0}, 5, 5},	//Dichina
				//{{12284.3,9200.54,0}, 8, 8}    // Berezino cleaning site				
               // {{13683.5,2923.14,46.3299},50,500},    // Skalisty
               // {{2751.9,5270.36,206.813},50,400},    // Zeleno   
			};
		};
...
class CfgInteractionModels
{
	...
	class WorkBench
	{
		...
		models[] = 
		{
			"workstand_f.p3d", //Basic Workbench
			"workbench_01_f.p3d" //Advanced Workbench
		};
	};
...
class CfgTerritories
{
	...
	prices[] =
	{
		...
		{100000,					75,			150					}, // Level 5
		{125000,					90,			180					}, // Level 6
		{150000,					105,		210					}, // Level 7
		{175000,					120,		240					}, // Level 8
		{200000,				135,		270		   			}, // Level 9
		{225000,				150,		300					}, // Level 10
		{250000,				200,		350					}, // Level 11
		{400000,				275,		475					}  // Level 12
	};
...
class CfgTraderCategories
{
	...
	//#include  "TRADERS\HVP\TraderCategoriesHWP.hpp"
	...
	#include "TRADERS\BANDIT\TraderCategoriesBANDIT.hpp"
};
...
class CfgExileArsenal
{
	...
	#include "TRADERS\BANDIT\ItemListBANDIT.hpp"
	#include "TRADERS\EXTIT\ItemListEXTIT.hpp"
};
