...
/*
	SM_Paint
*/
private _hasTexture = format["SM_CheckConstructionSkin:%1", _constructionID] call ExileServer_system_database_query_selectSingleField;
if (_hasTexture) then
{
	private _textures = format["SM_GetConstructionSkin:%1", _constructionID] call ExileServer_system_database_query_selectSingleField;
