...
switch (toLower worldName) do {
	...
	case "chernarus":
    {
        ...
        _signs = [
			...
			//BERINZINO TRADER SIGN
			["Exile_Sign_Armory",[11455.7,7512.8,0.00143433],70,[[-0,0,1],[-0,0,1]], false],
			//GM TRADER SIGN
			["Exile_Sign_Armory",[3708.91,5972.75,0.00143433],88,[[-0,0,1],[-0,0,1]], false]
